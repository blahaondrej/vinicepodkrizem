<?php
$title = "Vinice Pod křížem - Hibernal 2018";
?>
                                    ...
                                    <div class="col-md-5">
                                        <div class="product-image fl-wrap">
                                            <div class="single-slider fl-wrap" data-effects="slide">
                                                <img src="<?php echo $url; ?>/images/vina/detail/hibernal-2018.jpg" class="respimg" alt="Hibernal 2018">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                                ...
                                                <div class="tab">
                                                    <div id="tab-1" class="tab-content">
                                                        <ul class="product-opt-list fl-wrap">
                                                            <li><span>Odrůda: </span>Hibernal</li>
                                                            <li><span>Kategorie: </span>Polosuché</li>
                                                            <li><span>Přívlastek: </span>Kabinetní víno</li>
                                                            <li><span>Barva: </span>Bílé víno</li>
                                                            <li><span>Ročník: </span>2018</li>
                                                            <li><span>Obsah: </span>0,75l</li>
                                                        </ul>
                                                        <p>Hibernal je středně pozdní až pozdní, interspecifická moštová odrůda révy, určená k výrobě bílých vín, která byla vyšlechtěna roku 1944 v Německu, kříženec odrůd Seibel 7053 (Chancellor) a Ryzlink rýnský.</p>
