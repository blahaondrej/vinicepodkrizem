<?php
$title = "Vinice Pod křížem - Rheinriesling 2017";
?>
                            ...
                            <div class="col-md-5">
                                <div class="product-image fl-wrap">
                                    <div class="single-slider fl-wrap" data-effects="slide">
                                        <img src="<?php echo $url; ?>/images/vina/detail/ryzlink-rynsky-2017.jpg" class="respimg" alt="Rheinriesling 2017">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="product-text fl-wrap">
                                    <h2>Rheinriesling 2017</h2>
